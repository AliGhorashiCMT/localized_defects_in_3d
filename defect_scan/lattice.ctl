...
(define-param defectr 0.76)
(define-param h (/ (sqrt 3) 2))
(define-param kvecs (list (vector3 0.5 0.5 0.5))) ; list of k-vectors (list of kvecs or string to kvecs data file)
(define-param Ws      '())    ; point group parts of symops; see SYMMETRY EIGENVALUES part
(define-param ws      '())
(define-param opidxs  '())
(define-param res 16)
(define-param prefix "supercell")
